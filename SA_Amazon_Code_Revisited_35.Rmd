...
In a similar way, negative subjective information can also impact sentiment polarity. This has been analyzed but is not sowed here for brevity reasons. Words and tokens with positive subjective information will be inserted in additional files, just as words and tokens with negative subjective information.
...
Actually, the number of training reviews with *not* or *no* is limited among the false negatives. But it might be different among false positives. Moreover, the frequency could also be higher in the validation set, which we do not know.
Keeping negational unigrams will be given a try in ...
